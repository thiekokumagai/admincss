...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "btn btn-sm btn-info",
            dragDropStr: "<span><b>Selecionar ou arrastar</b></span>",
            abortStr: "Cancelar",
            cancelStr: "Cancelar",
            deletelStr: "Deletar",
            doneStr: "OK",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "Extensão não é válida. Extensões permitidas: ",
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.on('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).css('border', '2px dotted #ebebeb');
            });
